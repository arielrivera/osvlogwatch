...
try {
    Register-ScheduledTask `
        ...
        -Principal $Principal `
        -Settings $Settings `
        -Description "Monitors C:\Users\OSVHo\Documents\osvlogwatch\Folder for .7z files and runs TestResultValidator_v1.2.exe" `
        -ErrorAction Stop
    ...
    Write-Host ""
    Write-Host "Logs are written to: C:\Users\OSVHo\Documents\osvlogwatch\watcher.log" -ForegroundColor Gray
